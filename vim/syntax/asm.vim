...
"as86keyword
syn keyword asmType mov movl movb movw lss lea int jmp jmpi out outb push pop jnc jne je j ret iret shr shl cmp lidt lgdt cli lmsw call add inc sub xor and seg test xorl incl cmpl orl rep jz movsw cld in jnz
